...
export default function AdminProgramsPage() {
  ...
  const fetchPrograms = async (token: string) => {
    try {
      const response = await fetch(`${API_BASE_URL}/api/v1/admin/programs/`, {
        headers: {
  ...
  const handleSave = async () => {
    ...
    try {
      ...
      const url = editingProgram
        ? `${API_BASE_URL}/api/v1/admin/programs/${editingProgram.id}`
        : `${API_BASE_URL}/api/v1/admin/programs/`;
  ...
  const handleDelete = async (programId: number, programName: string) => {
    ...
    try {
      ...
      const response = await fetch(
        `${API_BASE_URL}/api/v1/admin/programs/${programId}`,
        {
          method: "DELETE",
          headers: {
            Authorization: `Bearer ${token}`,
          ...
          {programs.length === 0 && (
            <div className="text-center py-12">
              <p className="text-gray-500">
                Nenhum programa cadastrado. Crie o primeiro!
              </p>
            </div>
          )}
        </div>
                ...
                <div className="space-y-4">
                      ...
                      <div className="space-y-3">
                        <div>
                          ...
                          <input
                            ...
                            value={habit.name}
                            onChange={(e) =>
                              handleHabitChange(index, "name", e.target.value)
                            }
                  ...
                  {formData.habits.length === 0 && (
                    <p className="text-sm text-gray-500 text-center py-4">
                      Nenhum hábito adicionado. Clique em "Adicionar Hábito"
                      para começar.
                    </p>
                  )}
                </div>
